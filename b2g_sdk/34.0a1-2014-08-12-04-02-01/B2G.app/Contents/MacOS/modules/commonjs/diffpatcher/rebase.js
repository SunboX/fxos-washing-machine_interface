...
function rebase(result,parent,delta){var key,current,previous,update
for(key in parent){if(owns.call(parent,key)){previous=parent[key]
...
for(key in delta){if(owns.call(delta,key)){update=delta[key]
